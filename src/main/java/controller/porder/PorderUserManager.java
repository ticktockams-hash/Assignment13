...
import service.impl.PorderUserServiceImpl;
import util.Tool;       
        ...
        btnNewButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    PorderUserService porderUserService = new PorderUserServiceImpl();
                    porderUserService.addPorderUser(porderUser);
                    
                    FinishUser finishuser = new FinishUser(memberUser, porderUser);
